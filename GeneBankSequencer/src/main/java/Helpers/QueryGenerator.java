...
/**
	Generates length k Helpers.DNA strings for queries. It can generate duplicate queries.
	To avoid duplicates, use

	java Helpers.QueryGenerator <k> <n> | sort | uniq
...
public class QueryGenerator
{
	...
	{
		if (args.length != 2) {
			System.err.println("Usage: java Helpers.QueryGenerator <query length> <#queries>");
			System.exit(1);
		}
